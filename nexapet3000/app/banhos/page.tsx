...
function BanhosContent() {
  ...
  useEffect(() => {
    // We fetch all customers who are "Cliente de Pacote" and then filter by date in memory
    // to handle the range more easily since proximo_banho is a string
    const q = query(
    ...
    const timeout = setTimeout(() => {
      setLoading(prev => {
        if (prev) {
          console.warn('BanhosContent: Timeout de carregamento atingido.');
          return false;
        }
        return prev;
      });
